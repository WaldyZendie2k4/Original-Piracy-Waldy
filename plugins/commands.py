...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('⚡ UᎮDΛTΞS ⚡', url='https://t.me/WMF_OFFICIAL')
            ],
            [
                InlineKeyboardButton('⚡ Request group ⚡', url=f"https://t.me/+vIp2D8B3TiQ5NTk1"),
            ],
            [
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ', url='https://t.me/WMF_OFFICIAL') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
